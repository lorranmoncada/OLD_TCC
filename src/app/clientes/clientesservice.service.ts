...
export class ClientesserviceService {
 ...
 /*  public DeletarPerspectiva(processo: number): Observable<boolean> {
    return this.client.get<boolean>(`http://localhost:60409/api/clientes/ExcluirCliente/${processo}`);
  } */

  public DeletarPerspectiva(clientes: ClientesModel): Observable<boolean> {
    return this.client.post<boolean>('http://localhost:60409/api/clientes/ExcluirCliente', clientes);
  }
}
